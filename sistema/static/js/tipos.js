...
cabecera="<thead><tr><th>Nombre</th><th>Año</th><th>Descripción</th></tr></thead> <tfoot><th>&nbsp</th><th>&nbsp</th><th>&nbsp</th></tfoot>";
$("#dataTable").append(cabecera);                


var vartipo = "JIRONES Y AVENIDAS";
 $.ajax({
    //type: 'GET',
      type: 'POST',
 ...
 //table.destroy();
      ...
      //$("#dataTable").append(cabecera); 
           ...
           for (var i = 0; i < data.length; i++) {
              ...
              table.row.add( {"nombre": data[i].nombre, "anio":   data[i].anio, "descripcion":   data[i].descripcion } ).draw();//cargamos nueva data por filas
...
$("#btn1").click(function(){
  ...
  //window.location.href = "/foto/reportepdf/"+$("#lista").val();
   window.open("/foto/reportepdf/"+$("#lista").val(),'_blank');
